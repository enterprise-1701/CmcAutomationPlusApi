...
public class TokenSearchAPITest {
	...
	private static final String LINK_ACCOUNT_VERIFICATION = "Link Account Verification";
	private static final String LINK_ACCOUNT_TRANSACTION = "Load value for Unrestricted";
	private static final String LINK_ACCOUNT_PRODUCT = "Stored Value";
	private static final String LINK_ACCOUNT_AMOUNT = "$20.00";
	...
	public void tokenVerificationLinkAccount() throws Exception {
		...
		Assert.assertEquals(lPage.getTokenVerification(driver), LINK_ACCOUNT_VERIFICATION);
		Assert.assertEquals(lPage.getTokenTransaction(driver), LINK_ACCOUNT_TRANSACTION);
		Assert.assertEquals(lPage.getTokenProduct(driver), LINK_ACCOUNT_PRODUCT);
